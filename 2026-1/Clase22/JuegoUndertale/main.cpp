...
#include "Fuentes/Grafo/EquipoGrafo.hpp"
...
int main() {
    ...
    EquipoGrafo g;
    Personaje frisk("Frisk");
    Personaje sans("Sans");
    Personaje toriel("Toriel");

    g.insertarVertice(frisk);
    g.insertarVertice(sans);
    g.insertarVertice(toriel);

    g.insertarArista(frisk,sans);
    g.insertarArista(frisk,toriel);
    g.insertarArista(sans,toriel);
