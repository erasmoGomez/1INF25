...
${OBJECTDIR}/Casilla.o: Casilla.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Casilla.o Casilla.cpp

${OBJECTDIR}/Consumible.o: Consumible.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Consumible.o Consumible.cpp
...
${OBJECTDIR}/EquipoArbol.o: EquipoArbol.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/EquipoArbol.o EquipoArbol.cpp
...
${OBJECTDIR}/Inventario.o: Inventario.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Inventario.o Inventario.cpp
...
${OBJECTDIR}/Mago.o: Mago.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Mago.o Mago.cpp
...
${OBJECTDIR}/NodoArbol.o: NodoArbol.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/NodoArbol.o NodoArbol.cpp
